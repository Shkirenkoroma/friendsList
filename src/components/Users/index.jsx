  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        {items.filter((obj) => {const fullName = (obj.first_name + obj.last_name).toLowerCase();
        if (fullName.toLowerCase().includes(searchValue.toLowerCase()) || obj.email.toLowerCase().includes(searchValue)){
          return true;
